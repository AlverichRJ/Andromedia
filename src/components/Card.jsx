...
const Card = ({ image, title, subtitle, link }) => {
  return (
    <a href={link} className="  sm:grid sm:ml-36               md:grid grid-cols-1 m-3 md:ml-36   lg:m-4 lg:block lg:max-w-sm  lg:rounded-lg     xl:max-w-xl  xl:m-4  xl:overflow-hidden xl:rounded-xl  ">
