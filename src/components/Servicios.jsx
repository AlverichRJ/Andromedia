...
const Servicios = () => {
  ...
  return (
    <div className=" sm:h-[800px] md:h-screen lg:h-screen xl:h-screen uw:h-screen container mx-auto sm:mt-36 xl:mt-72 xl:py-16 xl:tracking-tighter" id="servicios">
